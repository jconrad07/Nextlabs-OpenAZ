 ...
 *    Resource_id (unique identifier) = support_101
 *    Ticket = support
 *     
 *  CloudAz PDP matches this request with "Allow Users in IT to View All Support Tickets" policy
 *  The policy effect is allow.
 *     
 * @author Amila Silva
 *
 */
public class AllowITDeptUsersToViewTickets {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * with PDP
		 */
		String configPath = AllowITDeptUsersToViewTickets.class.getResource("/openaz-pep.properties").toURI().getPath();
		...
		System.out.println("");
		System.out.println("***********************************************************************");
		System.out.println(" Matching Policy : Allow Users from IT Department to View All Support Tickets");
		System.out.println("-----------------------------------------------------------------------");
